  ...
  return (
    <Card className="transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
      <CardHeader className="pb-3">
        <div className="aspect-video w-full bg-gradient-to-br from-muted to-secondary rounded-lg mb-4 overflow-hidden border-2 border-border">
          <img
      ...
      <CardContent className="space-y-4">
        ...
        <div className="flex items-center gap-2 pt-2 border-t border-border">
          ...
          <div>
            ...
            <p className="font-medium text-foreground">{currentChurch.head_pastor}</p>
          </div>
        </div>
        <Button
          asChild
